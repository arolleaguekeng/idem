...
export class VisualIdentityData {
  static logos: LogoOption[] = [
    {
      id: 'logo1',
      name: 'Modern Minimalist',
      url: 'https://via.placeholder.com/300/121212/FFFFFF?text=Modern+Logo',
    ...
    },
    {
      ...
      url: 'https://via.placeholder.com/300/1a1a1a/e74c3c?text=Geometric+Logo',
      svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
    ...
    },
    {
      id: 'logo3',
      name: 'Tech Forward',
      url: 'https://via.placeholder.com/300/2c3e50/27ae60?text=Tech+Logo',
      svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
    ...
    },
    {
      ...
      url: 'https://via.placeholder.com/300/8e44ad/f1c40f?text=Elegant+Logo',
      svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
        <defs>
  ...
  static typographyOptions: TypographyOption[] = [
    {
      id: 'typo1',
      name: 'Modern Sans',
